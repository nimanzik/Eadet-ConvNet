...
def main():
    ...
    parser.add_argument(
        '--num-workers', type=int, default=1, metavar='W',
    ...
    parser.add_argument(
        '--train-split-ratio', type=float, default=0.8, metavar='R',
        help='the portion of the dataset used for training (default: 0.8)')
    parser.add_argument(
        '--random-split', action='store_true', default=False,
    ...
    parser.add_argument(
        '--test-model', action='store_true', default=False,
    ...
    parser.add_argument(
        '--save-costs', action='store_true', default=False,
    ...
    train_loader = DataLoader(
        dataset=CustomDataset(
            images_filename_tmpl, partition['train'], train_targets),
    ...
    test_loader = DataLoader(
        dataset=CustomDataset(
            images_filename_tmpl, partition['test'], test_targets),
    ...
    if args.summary:
        ...
        with open(filename_summary, 'w') as fid:
            ...
            summary(
                dummy_model, input_shape, batch_size=args.batch_size,
                device=device.type)
